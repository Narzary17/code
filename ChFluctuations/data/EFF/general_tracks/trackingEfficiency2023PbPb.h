...
TrkEff2023PbPb::TrkEff2023PbPb(std::string collectionName, std::string quality, bool isQuiet_, std::string filePath){
  ...
  if( collectionName.compare("general") == 0 ){
    ...
    if( quality.compare("Loose") == 0 ) trkEff = TFile::Open( (filePath + "GeneralTracks_2023_PythiaHydjetQCD_Official_Eff_3D_Nominal_9thJune2025.root").c_str(),"open");
    else if( quality.compare("Tight") == 0 ) trkEff = TFile::Open( (filePath + "GeneralTracks_2023_PythiaHydjetQCD_Official_Eff_3D_Tight_9thJune2025.root").c_str(),"open");
    else trkEff = TFile::Open( (filePath + "GeneralTracks_2023_PythiaHydjetQCD_Official_Eff_3D_Loose_9thJune2025.root").c_str(),"open");
    ...
    if( quality.compare("Loose") == 0) trkFake = TFile::Open( (filePath + "GeneralTracks_2023_HydjetMB_Official_Eff_3D_Loose_9thJune2025.root").c_str(),"open");
    else if( quality.compare("Tight") == 0) trkFake = TFile::Open( (filePath + "GeneralTracks_2023_HydjetMB_Official_Eff_3D_Tight_9thJune2025.root").c_str(),"open");
    else trkFake = TFile::Open( (filePath + "GeneralTracks_2023_HydjetMB_Official_Eff_3D_Nominal_9thJune2025.root").c_str(),"open");
